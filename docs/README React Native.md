...
React Native is [BSD licensed](https://github.com/facebook/react-native/blob/master/LICENSE). We also provide an additional [patent grant](https://github.com/facebook/react-native/blob/master/PATENTS).

React Native documentation is [Creative Commons licensed](https://github.com/facebook/react-native/blob/master/LICENSE-docs).
